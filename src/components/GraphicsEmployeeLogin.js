        ...
        if (snapshot.exists()) {
          ...
          if (employee) {
            ...
            if (employee.password === password) {
              // Check if Graphics Department employee
              const dept = employee.department ? employee.department.toLowerCase() : '';
              if (dept.includes('graphics') || dept.includes('graphic')) {
                // Valid Graphics employee
                ...
                console.log('Graphics Employee Login - Employee data:', employee);
                console.log('Graphics Employee Login - Role:', employee.role);
                
                if (employee.role === 'head') {
                  console.log('Routing to Graphics Dashboard (Head)');
                  // Route to Graphics Dashboard (Head Dashboard)
                  navigate('/graphics');
                } else {
                ...
                setError('You are not authorized to access Graphics Employee Dashboard');
                return;
              }
            } else {
...
export default GraphicsEmployeeLogin;
