            ...
            if (employee.password === password) {
              ...
              if (dept.includes('strategy')) {
                ...
                if (employee.role === 'head') {
                  // Route to Strategy Head Dashboard
                  navigate('/strategy-head');
                } else {
                  // Route to Strategy Dashboard (regular employee)
                  navigate('/strategy');
                }
                return;
              } else {
                setError('You are not authorized to access Strategy Dashboard');
                return;
              }
            } else {
...
export default StrategyEmployeeLogin;
