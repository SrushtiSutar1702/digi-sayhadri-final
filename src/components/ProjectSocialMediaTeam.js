...
import { Share2, LogOut, CheckCircle, XCircle, Clock, Calendar, User } from 'lucide-react';
    ...
    <div className="dashboard">
      ...
      <div className="dashboard-header">
        <div className="header-left">
          <Share2 size={32} />
          <div>
            <h1>📱 Social Media Team Dashboard</h1>
            <p>Manage social media team tasks and assign to team members</p>
          </div>
        </div>
      ...
      <div className="card full-width">
        <div className="card-header">
          <h2>Social Media Team Tasks ({filteredTasks.length})</h2>
        </div>
        {filteredTasks.length === 0 ? (
          <div className="empty-state">
            <p>No tasks assigned to Social Media team for this month.</p>
          </div>
        ) : (
          <div style={{overflowX: 'auto', padding: '20px'}}>
            <table style={{
              ...
              <thead>
                <tr style={{backgroundColor: '#1abc9c', color: 'white'}}>
        ...
        <div className="day-plan-modal">
          <div className="day-plan-content" style={{maxWidth: '500px'}}>
            <div className="day-plan-header">
              <h2>👤 Assign Task to Social Media Team Member</h2>
              <button 
                className="close-btn" 
                onClick={() => {
                  setShowAssignMemberModal(false);
            ...
            <div style={{padding: '20px'}}>
              ...
              <div className="form-group">
                <label style={{display: 'block', marginBottom: '8px', fontWeight: '600'}}>
                  Select Social Media Team Member *
                </label>
                <select
                ...
                >
                  ...
                  {socialMediaTeamMembers.map(member => (
