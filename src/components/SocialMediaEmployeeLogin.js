...
const SocialMediaEmployeeLogin = () => {
        ...
        if (snapshot.exists()) {
          ...
          if (employee) {
            ...
            if (employee.password === password) {
              // Check if Social Media Department employee
              const dept = employee.department ? employee.department.toLowerCase() : '';
              if (dept.includes('social') || dept.includes('media')) {
                // Valid Social Media employee
                // Store employee info in localStorage for the dashboard
                ...
                try {
                  ...
                  // Store employee info in sessionStorage as backup
                  sessionStorage.setItem('socialMediaEmployee', JSON.stringify(employee));
                }
                
                // Check role and route accordingly
                console.log('Social Media Employee Login - Full Employee data:', employee);
                console.log('Social Media Employee Login - Role field:', employee.role);
                console.log('Social Media Employee Login - Role type:', typeof employee.role);
                
                if (employee.role === 'head') {
                  console.log('✅ Routing to Social Media Dashboard (Head)');
                  // Route to Social Media Dashboard (Head Dashboard)
                  navigate('/social-media');
                } else {
                  console.log('➡️ Routing to Social Media Employee Dashboard (Employee)');
                  // Route to Social Media Employee Dashboard
                  navigate('/social-media-employee');
                }
                return;
              } else {
                setError('You are not authorized to access Social Media Employee Dashboard');
                return;
              }
            } else {
...
export default SocialMediaEmployeeLogin;
